  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addToast({
        type: 'success',
        title: 'Welcome back!',
        message: `Successfully logged in as ${res.user.email}.`,
      });
      ...
      <div className="container" style={{ maxWidth: '440px', zIndex: 1, padding: 'var(--sp-4)' }}>
        <div style={{ textAlign: 'center', marginBottom: 'var(--sp-6)' }}>
          ...
          <p className="text-muted" style={{ marginTop: 'var(--sp-2)', fontSize: 'var(--text-sm)' }}>
            Sign in to unlock AI-powered codebase exploration
          </p>
        </div>
        ...
        <GlassCard variant="bordered" style={{ padding: 'var(--sp-6)' }}>
          ...
          <div style={{ marginTop: 'var(--sp-6)', textAlign: 'center', fontSize: 'var(--text-xs)' }}>
            <span className="text-muted">New to CodeVista? </span>
            <Link to="/signup" className="link-hover" style={{ color: 'var(--primary-light)', fontWeight: 'var(--weight-semibold)', textDecoration: 'none' }}>
              Create an account
            </Link>
          </div>
        </GlassCard>
