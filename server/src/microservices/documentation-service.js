...
const app = express();
const PORT = parseInt(process.env.PORT_DOC || '3005', 10);
...
// Documentation Routes (mount under /api/repositories/:id/documentation with authentication and ownership validation)
...
function shutdown(signal) {
  console.log(`\n[Documentation Service] ${signal} received — shutting down gracefully…`);
  server.close(() => {
    closeDb();
    console.log('[Documentation Service] Goodbye.');
    process.exit(0);
  });
